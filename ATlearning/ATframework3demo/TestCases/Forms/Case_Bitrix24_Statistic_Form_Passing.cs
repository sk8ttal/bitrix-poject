    ...
    public class Case_Bitrix24_Statistic_Form_Passing : CaseCollectionBuilder
    {
        ...
        public void FormPassing(PortalHomePage homePage)
        {
            ...
            var formsMainPage = homePage
                ...
                //один из списка
                .ChangeQuestionType(testForm.Questions[4], testForm.Type[2])
                ...
                .AddNewOption(testForm.Questions[4], 4)
            ...
            formsMainPage = formsMainPage
                ...
                .ChooseOptionInQuestion("Ответ 1", testForm.Questions[3])
                //выбрать опцию 3 в вопросе 3 (несколько из списка)
                .ChooseOptionInQuestion("Ответ 3", testForm.Questions[3])
                //выбрать опцию 2 в вопросе 4 (один из списка)
                .ChooseOptionInQuestion("Ответ 4", testForm.Questions[4])
                //завершить прохождение формы
                .FinishForm();

            var formResultPage = formsMainPage
